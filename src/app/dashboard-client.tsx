      ...
      <div className="p-4 flex items-center gap-3">
        ...
        {!collapsed && (
          <div className="min-w-0">
            <h1 className="text-sm font-bold truncate" style={{ color: currentProject.brandColor }}>{currentProject.name}</h1>
            <p className="text-[10px] text-sidebar-foreground/60">{currentProject.industry} — Command Center</p>
          </div>
        )}
      </div>
